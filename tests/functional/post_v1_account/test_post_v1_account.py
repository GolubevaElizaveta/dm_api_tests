...
from dm_api_account.apis.email_api import EmailApi
...
def test_post_v1_account():
    ...
    email_api = EmailApi(host="http://5.63.153.31:5051")

    login = 'vmenshikov_test51'
    ...
    # Меняем email
    new_email = "new_email11@mail.ru"
    json_data = {
        "login": login,
        "password": password,
        "email": new_email
    }
    response = email_api.put_v1_account_email(json_data=json_data)
    print(response.status_code)
